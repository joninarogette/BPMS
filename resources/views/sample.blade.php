...
<link rel="stylesheet" href="{{asset('design/css/bootstrap-responsive.min.css')}}" />
<link rel="stylesheet" href="{{asset('design/css/fullcalendar.css')}}" />
<link rel="stylesheet" href="{{asset('design/css/matrix-style.css')}}" />
<link rel="stylesheet" href="{{asset('design/css/matrix-media.css')}}" />
<link href="{{asset('design/font-awesome/css/font-awesome.css')}}" rel="stylesheet" />
<link rel="stylesheet" href="{{asset('design/css/jquery.gritter.css')}}" />
